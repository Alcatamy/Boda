    ...
    <main>
      <Hero />
        ...
        <footer style={{
          ...
          <p style={{ margin: 0, textAlign: "center" }}>Diseñada y desarrollada por<br /><span style={{fontFamily: "var(--font-script)", fontSize: "1.5rem", textTransform: "none", display: "block", marginTop: "0.5rem"}}>Adrián y Nadia</span></p>
        </footer>
      </main>
  );
}
